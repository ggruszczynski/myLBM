...
vector<Vector2d, Eigen::aligned_allocator<Eigen::Vector2d> >  D2Q9Constants:: e  = [] {

	vector<Vector2d, Eigen::aligned_allocator<Eigen::Vector2d>> tempVec;
	//std::vector<Eigen::Vector2d, Eigen::aligned_allocator<Eigen::Vector2d> > tempVec;
	tempVec.reserve(9);

	tempVec.push_back(Vector2d(0, 0));

	tempVec.push_back(Vector2d(1, 0));
	tempVec.push_back(Vector2d(0, 1));
	tempVec.push_back(Vector2d(-1, 0));
	tempVec.push_back(Vector2d(0, -1));

	tempVec.push_back(Vector2d(1, 1));
	tempVec.push_back(Vector2d(-1, 1));
	tempVec.push_back(Vector2d(-1, -1));
	tempVec.push_back(Vector2d(1, -1));
